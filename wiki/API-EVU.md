...
Diese Seite richtet sich an **smartENERGY** – als EVU und Betreiber der Strompreis-API – nicht an Endanwender der Integration.
...
- Die Morgen-Preise für den Folgetag werden **ab 17 Uhr** (Konstante `NEXT_DAY_PRICES_HOUR`) abgerufen, mit einem deterministischen, aus der Konfiguration abgeleiteten **Jitter über ein 20-Minuten-Fenster** (`FETCH_JITTER_MINUTES`) – so entsteht keine Lastspitze exakt zur vollen Stunde.
