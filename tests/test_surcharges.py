...
def test_elektrizitaetsabgabe_gesenkt_bis_ende_2026():
...
def test_elektrizitaetsabgabe_regelsatz_ab_2027():
...
def test_foerderbeitrag_gilt_seit_2026():
...
def test_summe_der_abgaben_2027():
...
def test_aufschluesselung_mit_beiden_positionen():
